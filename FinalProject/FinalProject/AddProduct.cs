...
namespace FinalProject
{
    public partial class AddProduct : Form
    {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            sqlConnection.Open();
            //sqlCommand.CommandText = "INSERT INTO CATEGORY (CATEGORYNAME,NUMOFPRODUCTS) VALUES ('milk product',5)";
            sqlCommand.CommandText = "INSERT INTO PRODUCT (PRODUCTID,CATEGORYID,PRODUCTPRICE,PRODUCTNAME,QUANTITY) VALUES ('" + id.Text + "','" + categoryid.Text + "','" + price.Text + "','" + name.Text + "','" + quantity.Text + "')";
